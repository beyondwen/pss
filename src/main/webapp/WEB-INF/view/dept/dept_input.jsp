...
<head>
    ...
    <script src="/js/model/dept/dept.js" type="text/javascript"></script>

    <title>成都蓝源进销存系统(教学版)-部门编辑界面</title>
</head>
<body>
<%@include file="../message.jsp" %>
<s:form id="deptForm" action="dept_save">
        ...
        <div class="content-text">
            <div class="square-order">
                <div style="border:1px solid #cecece;">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr bgcolor="#FFFFFF">
                            <td width="13%" height="30" align="center">部门</td>
                            <td width="36%">
