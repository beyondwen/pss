...
<head>
    ...
    <title>成都蓝源进销存系统(教学版)-菜单列表页</title>
</head>
<body>
        ...
        <div class="content-text">
            ...
            <div class="square-o-top">
                ...
                <tr>
                    ...
                    <td width="136"><a href="menu_input.action"><img src="/images/can_b_02.gif" border="0"/></a>
                    </td>
                </tr>
                </table>
                    ...
                    <s:iterator value="pageResult.row">
                        <tr align="center" bgcolor="#FFFFFF">
                            ...
                            <td><img src="images/icon_3.gif"/>
	                            ...
	                            <a class="xiu" href="#" onclick="updateDomain('menu_input.action?id=${id}');">修改</a>
	                            </span>
                                <img src="/images/icon_04.gif"/> <span style="line-height:12px; text-align:center;">
	                            <a class="xiu" href="#" onclick="deleteDomain('menu_delete.action','${id}',this);">删除</a>
                                </span>
                            </td>
                        </tr>
                    </s:iterator>
