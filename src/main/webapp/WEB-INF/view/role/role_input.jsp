...
<head>
    ...
    <script src="/js/model/role/role.js" type="text/javascript"></script>

    <title>成都蓝源进销存系统(教学版)-角色编辑界面</title>
</head>
<body>
<%@include file="../message.jsp" %>
<s:form id="roleForm" action="role_save">
            ...
            <div class="square-order">
                <div style="border:1px solid #cecece;">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr bgcolor="#FFFFFF">
                            <td width="13%" height="30" align="center">角色所拥有的资源</td>
                            <td width="36%">
