...
<head>
    ...
    <script src="/js/model/resource/resource.js" type="text/javascript"></script>

    <title>成都蓝源进销存系统(教学版)-资源编辑界面</title>
</head>
<body>
                ...
                <div style="border:1px solid #cecece;">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr bgcolor="#FFFFFF">
                            ...
                            <td width="36%">
                                <s:textfield name="method" size="25"/>
                            </td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                            <td width="13%" height="30" align="center">备注</td>
                            <td width="36%">
                                <s:textfield name="descs" size="25"/>
                            </td>
                        </tr>
                    </table>
                </div>
